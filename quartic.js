var QUARTIC = function(){
    ...
    function calcSC_ak1(DBL_EPSILON, N, a, b, iPar, K, u, v, qk) {
        ...
        var sdPar =  {}; // sdPar is a dummy variable for passing the two parameters--c and d--into QuadSD_ak1 by reference
     ...
     * @returns 
     */
    ComplexNumber.prototype.round = function(numberOfDecimals) {

        this.re = Number(this.re.toFixed(numberOfDecimals));
        this.im = Number(this.im.toFixed(numberOfDecimals));
    };
     ...
     * @returns 
     */
    ComplexNumber.prototype.getRounded = function(numberOfDecimals){
        var numberToRound = this.clone();
        numberToRound.round(numberOfDecimals);
